...
class LifeboatToPolars:
    ...
    def create_photos_df(self, photos: List[Photo]) -> pl.DataFrame:
        ...
        for photo in photos:
            record = {
                ...
                "date_taken_granularity": photo.dateTaken.granularity if photo.dateTaken else None,
        ...
        records = [
            {
                ...
                "photo_contributions": contributor.contributions.photo if contributor.contributions else 0,
                "tag_contributions": contributor.contributions.tag if contributor.contributions else 0,
                "comment_contributions": contributor.contributions.comment if contributor.contributions else 0
            }
    ...
    def create_full_dataset(self) -> Dict[str, pl.DataFrame]:
        ...
        datasets["photos_enriched"] = (
            datasets["photos"]
            .join(datasets["licenses"], left_on="license_id", right_on="license_id", how="left")
            .join(
